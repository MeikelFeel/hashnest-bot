...
getmonth = json.loads(db.get(today - timedelta(days=30)).decode('utf-8') or [accusdvalue, s7hashrate, s9hashrate, l3hashrate])
getyear = json.loads(db.get(today - timedelta(days=365)).decode('utf-8') or [accusdvalue, s7hashrate, s9hashrate, l3hashrate])
