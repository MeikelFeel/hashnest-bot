...
print('[' + '3'*(int(math.ceil(40*l3valuepercent))) + '9'*(int(math.ceil(40*s9valuepercent))) + '7'*(int(math.ceil(40*s7valuepercent))) + 'L'*(int(math.ceil(40*ltcvaluepercent))) + 'B'*(int(math.ceil(40*btcvaluepercent))) + ']')
